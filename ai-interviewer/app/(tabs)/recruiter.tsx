...
const getStatusColor = (status: string) => {
  switch (status) {
    ...
    case "in_review":
      return { bg: "rgba(139,139,139,0.1)", text: "#8E8E93" };
    case "interview":
...
export default function RecruiterScreen() {
  ...
  // For now, use mock data until API integration
      ...
      >
        <View style={styles.candidateHeader}>
          <View style={styles.candidateInfo}>
            <View style={styles.avatar}>
              <Text style={styles.avatarText}>
                {item.name?.split(" ").map(n => n[0]).join("").substring(0, 2) || "CN"}
              </Text>
            </View>
            <View>
          ...
          <View style={styles.scoreContainer}>
            <View style={[styles.scoreBadge, { backgroundColor: statusStyle.bg }]}>
              <Text style={[styles.scoreText, { color: statusStyle.text }]}>
                {item.score} Score
              </Text>
            </View>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>
            {isRecruiter ? "Candidate Interviews" : "Candidate Rankings"}
          </Text>
        </View>
